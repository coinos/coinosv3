...
const HATS = [
  {
    id: 'beanie', nameKey: 'hatBeanie', sat: 21, w: 92, b: 79, r: -8,
  ...
  {
    id: 'trucker', nameKey: 'hatTrucker', sat: 2100, w: 106, b: 69, r: -6,
  ...
  {
    id: 'cowboy', nameKey: 'hatCowboy', sat: 21000, w: 122, b: 69, r: -7,
  ...
  {
    id: 'fedora', nameKey: 'hatFedora', sat: 21000, w: 118, b: 71, r: -8,
  ...
  {
    id: 'bowler', nameKey: 'hatBowler', sat: 210000, w: 104, b: 71, r: -7,
  ...
  {
    id: 'top', nameKey: 'hatTop', sat: 210000, w: 96, b: 73, r: -7,
  ...
  {
    id: 'wizard', nameKey: 'hatWizard', sat: 2100000, w: 112, b: 83, r: -4, dx: -8,
...
// -58, not -50: every hat rides a couple of pixels left of center —
// the art leans right and dead-center read as drifting off the head.
const posStyle = (hat) => `width:${hat.w}%;bottom:${hat.b}%;transform:translateX(${-58 + (hat.dx || 0)}%) rotate(${hat.r}deg)`;
...
export function hatsFeature(ctx) {
  ...
  return {
    ...
    hatShopEntry() {
      return h('button', {
        class: 'btn-sm', style: 'margin-top:6px;align-self:flex-start', onClick: openShop,
      }, '🎩 ' + t('hatShopSupport'));
    },
    screenView() {
