...
const STR = {
  en: {
    ...
    switchIdentityTitle: 'Switch account',
    switchIdentityDesc: 'Accounts already signed in on this device. Tap one to switch — nothing is logged out.',
    signInNew: 'Sign into a new account',
    identityNoKey: 'Not opened on this device yet',
    clearAll: 'Delete all',
    ...
    logoutPopBlurb: 'Your accounts stay saved on this device.',
    logoutOne: 'Log out of {name}',
    logoutOneBlurbLogin: 'Only this account leaves — the others stay signed in. You can sign back in with the same key anytime.',
    logoutOneBlurbSeed: 'Only this account leaves — the others stay signed in. It is removed from this device, so make sure you have its recovery phrase.',
    logoutAll: 'Log out of all accounts',
    clearAllWarn: '⚠ This removes every account from this device. Any account whose recovery phrase or key you have not backed up will be lost for good.',
    removeWalletTitle: 'Remove account',
    removeWalletWarn: '⚠ Remove “{name}” from this device? It will be gone from this browser — make sure you have its recovery phrase. Other accounts aren’t affected.',
    rename: 'Rename',
    remove: 'Remove',
    ...
    walletLabelN: 'Account {n}',
    watchLabelN: 'Watch {n}',
    saveDevice: 'Save on this device',
    forgetDevice: 'Saved · forget',
    savedTag: 'saved',
    setPassword: 'Set a password (optional)',
    setPasswordDesc: 'Encrypts this account on this device — leave it blank to save without a password. You will need it to unlock saved accounts later.',
    passwordOptional: 'Password (optional)',
    changePassword: 'Change password',
    changePasswordDesc: 'Re-encrypt your saved-to-device accounts with a new password. Leave the new password blank to remove it.',
    ...
    lockPwSkip: 'Not now',
    unlockSaved: 'Unlock saved accounts',
    unlockSavedDesc: 'Enter your password to open the accounts saved on this device.',
    unlock: 'Unlock',
    useAnotherWallet: 'Use another account',
    save: 'Save',
    ...
    hiwStandaloneTitle: 'Keep a copy',
    hiwStandalone1: 'The whole wallet fits in one file. Download it, keep it on a hard drive or USB stick, and open it in any browser — it runs from there with no server and no install, and your twelve words bring your money with you.',
    hiwStandaloneLink: 'Download the standalone wallet',
    ...
    msgEmojiAddPack: 'Add an emoji pack',
    msgEmojiPackHint: 'Paste a pack link or naddr…',
    msgEmojiPackAdd: 'Add',
    ...
    currencyLabel: 'Show amounts in',
    feedTitle: 'Feed',
    feedFollowingName: 'Following',
    feedNew: 'New feed',
    feedNewName: 'New feed',
    feedEdit: 'Edit feed',
    feedName: 'Name',
    feedNameHint: 'e.g. Bitcoin builders',
    feedPeople: 'People',
    feedFollowsToggle: 'Everyone I follow',
    feedAddPerson: 'Add someone…',
    feedTopics: 'Topics',
    feedTopicsHint: '#bitcoin #nostr',
    ...
    feedSumFollows: 'Everyone you follow',
    feedSumFollowsPlus: 'Everyone you follow + {n} more',
    feedSumPeople: '{n} people',
    feedPacks: 'Follow packs',
    posTitle: 'Point of sale',
    posDesc: 'Charge a customer a set amount, with an optional tip prompt. Bills and tips are counted separately.',
    posOpen: 'Open',
    posEnterAmount: 'Enter an amount first',
    posNeedsSpending: 'Point of sale takes Lightning into Spending — connect first',
    posNoteHint: 'Note (optional)',
    posCharge: 'Charge',
    posAskTip: 'Ask the customer for a tip',
    posTipChoices: 'Tip choices',
    posYourBill: 'Your bill',
    posAddTip: 'Add a tip?',
    posTipCustom: 'Other',
    posNoTip: 'No tip',
    posTotalLine: 'Total {n}',
    posContinue: 'Continue',
    posScanToPay: 'Scan to pay',
    posBreakdown: 'Bill {bill} + tip {tip} {u}',
    posWaiting: 'Waiting for payment…',
    posPaid: 'Paid',
    posNewSale: 'New sale',
    posInvoiceFailed: 'Could not create an invoice',
    posInvoiceExpired: 'That invoice expired before it was paid',
    posMemo: 'Bill {bill}, tip {tip}',
    posSalesToday: 'Today',
    posBills: 'Bills',
    posTips: 'Tips',
    posTotal: 'Total',
    ...
    linkHandlerBitcoin: 'bitcoin: links',
    linkHandlerAsked: 'Your browser is asking — allow it to finish',
    linkHandlerRefused: 'Your browser would not register this here',
    feedAddPack: 'Search packs, or paste a following.space link…',
    feedPacksHelp: 'A pack is a list someone curates. Its members are read live, so the feed follows the list as it changes.',
    feedPackMembers: '{n} members',
    feedPackUntitled: 'Untitled pack',
    feedShareList: 'Keep as a nostr list',
    feedShareListHelp: 'Published under your key as a follow set (NIP-51), so other nostr apps show the same list. Untick to remove the list from the relays; the feed stays here.',
    feedPrivateMember: 'Private member, added in another app',
    feedListPeople: '{n} people',
    postCopyLink: 'Copy link',
    postShare: 'Share',
    listAddTo: 'Add to a list',
    listPickTitle: 'Lists',
    listPickEmpty: 'No lists yet. A feed of people is a list.',
    listNew: 'New list…',
    profLists: 'Lists',
    searchTopicRow: 'Posts on this topic',
    searchTopicFor: 'Posts tagged #{q}',
    alertsTitle: 'Notifications',
    alertsSub: 'Zaps, reactions and replies to your posts',
    alertsNew: '{n} new',
    alertsEmpty: 'Nothing yet. Zaps, reactions and replies to your posts will show up here.',
    alertZap: 'zapped you {sats}',
    alertReact: 'reacted {emoji}',
    ...
    feedFollowed: 'Following them',
    feedUnfollowed: 'Unfollowed',
    feedFollowingN: 'Posts from {n} people you follow',
    feedFollowing1: 'Posts from the one person you follow',
    feedNoFollowsShort: 'Follow people to fill this',
    ...
    postBoost: 'Boost',
    postBoosted: 'Boosted',
    postBoostedAlready: 'You already boosted that',
    postQuote: 'Quote',
    postMore: 'More',
    postMute: 'Mute',
    postUnmute: 'Unmute',
    postMuted: 'Muted — their posts are hidden',
    postUnmuted: 'Unmuted',
    postBlock: 'Block and unfollow',
    postMuteThread: 'Mute this thread',
    postUnmuteThread: 'Unmute this thread',
    postReport: 'Report…',
    reportTitle: 'Report this post',
    reportHelp: 'A report is public (NIP-56). People who follow you see this post folded; the post is hidden for you.',
    reportSpam: 'Spam',
    reportImpersonation: 'Impersonation',
    reportNudity: 'Nudity',
    reportProfanity: 'Harassment or abuse',
    reportIllegal: 'Illegal content',
    reportMalware: 'Scam or malware',
    reportOther: 'Something else',
    reportSent: 'Reported',
    foldReported1: 'Reported by {name}',
    foldReportedN: 'Reported by {n} people you follow',
    foldShow: 'Show',
    quoteHidden: 'Hidden post',
    profMutedBanner: 'Muted — their posts are hidden everywhere else',
    modTitle: 'Muted and hidden',
    modDesc: 'Your mute list (NIP-51) follows you to other nostr apps, and theirs applies here.',
    modPeople: 'Muted people',
    modNoPeople: 'Nobody muted',
    modWords: 'Hidden words and hashtags',
    modWordHint: 'Add a word, phrase or #hashtag',
    modAdd: 'Add',
    modThreads: '{n} muted threads',
    modSpamToggle: 'Hide repeated posts from strangers',
    modSpamHelp: 'A post of 60+ characters posted again and again is spam; someone you don\'t follow who does it five times is hidden for the session. Posts stuffed with more than ten hashtags are hidden too.',
    modReportsToggle: 'Fold posts reported by people you follow',
    modReportsHelp: 'Their reports (NIP-56) are read from the relays. A flagged post is shown collapsed, with who flagged it; tap to see it anyway.',
    postBlocked: 'Blocked',
    zapSending: 'Sending your zap…',
    msgReply: 'Reply',
    profNewPost: 'New post',
    profYourProfile: 'Your profile',
    profComposePh: "What's on your mind?",
    profPostBtn: 'Post',
    profPosted: 'Posted',
    ...
    publicChatOpenApp: 'Open coinos',
    publicChatLoading: 'Loading messages…',
    ...
    noteRefLink: 'view note',
    noteRefLoading: 'Fetching note…',
    noteRefNotFound: "Couldn't find that note on the relays.",
    ...
    arkRenewedHistory: 'Renewed',
    arkDepthNotice: 'Unilateral exit costs about {fee} sats.',
    arkDepthFree: 'free',
    arkDepthBtn: 'Manage',
    ...
    arkCoinsColExpiry: 'Expiry',
    arkCoinsColExit: 'Exit cost',
    arkCoinsColRenew: 'Renewal',
    arkCoinsChipRenewTitle: 'This coin’s share of the renewal fee — the fee is priced on all the coins together and rounded up once, so tiny shares add almost nothing',
    arkCoinsChipRenewTiny: '< 1 sat',
    ...
    arkCoinsRenewing: 'renewing',
    arkCoinsIntroRenewing: 'Your Spending balance of {total} is being renewed: the coins below are in a round and come back as one fresh coin. Each can be pulled on-chain without the server’s help — at a cost that grows with the coin’s history.',
    arkRenewingTitle: 'Renewal in progress',
    arkRenewingLine: '{amount} sats → one fresh coin{fee}',
    arkRenewingFee: ', fee {fee} sats',
    ...
    arkCoinsExitBtn: 'Exit now',
    arkExitConfirmTitle: 'Start a unilateral exit?',
    arkExitConfirmBody: 'This brings your Spending coins to Savings on-chain without the server, by publishing each coin’s transaction history. Nothing needs the server’s cooperation — that is the point — but it is slow and it costs mining fees.',
    arkExitConfirmCoins: 'Coins',
    arkExitConfirmAmount: 'Amount',
    arkExitConfirmFee: 'Mining fees (about, paid from Savings)',
    arkExitConfirmSavings: 'Savings available for fees',
    arkExitConfirmWait: 'The funds arrive in Savings only once each coin’s timelock has run out — hours to days. An exit can’t be stopped once it has started.',
    arkExitConfirmGo: 'Start the exit',
    ...
    arkCoinsRenewDesc: 'Your wallet renews coins automatically once they are close to expiring and renewal is free. Renewing early is an option if you would rather pay a small fee now to keep your exit cost low should the coinos server ever stop responding when you want to bring your funds on-chain. A renewal replaces your coins with a single fresh one in the next round ({every}), which flattens their history. The fee depends on how close the coin is to expiry — the closer, the cheaper:',
    ...
    arkCoinsRenewSome: 'Renew {n} selected for {fee}',
    arkCoinsRenewNone: 'Select coins to renew',
    arkCoinsSelectAll: 'Select all',
    arkCoinsSpanDay: '1 day',
    arkCoinsSpanDays: '{n} days',
    arkCoinsSpanHour: '1 hour',
    arkCoinsSpanHours: '{n} hours',
    arkCoinsSchedOver: 'more than {span} left',
    arkCoinsSchedBetween: '{a} to {b} left',
    arkCoinsSchedFinal: 'less than {span} left',
    arkUniUneconomical: 'A trustless on-chain exit would cost about {fee} sats in mining fees — more than the {n} sats it would move, so it isn’t offered. For a balance this size, send it out over Lightning instead: no mining fees at all.',
    ...
    msgJoin: 'Join',
    msgCreate: 'Create',
    msgInvitePlaceholder: 'Paste an invite link, or search',
    msgDiscoverTitle: 'Suggested communities',
    msgHubCredit: 'From the Vector Hub',
    msgHubLoading: 'Finding communities…',
    msgHubFailed: 'Could not load suggestions right now.',
    msgJoined: 'joined',
    ...
    syncStorageHow: 'Wallet state too large for a relay event is encrypted and stored as a blob on these Blossom servers (one per line). Any Blossom server works — run your own or use another provider.',
    syncStorageSave: 'Save servers',
    syncStorageReset: 'Use default',
    syncStorageSaved: 'Sync storage servers saved',
    syncStorageInvalid: 'Enter at least one https:// server',
    syncStoragePending: '{n} snapshot(s) waiting to upload',
    ...
    claimBodyExisting: 'Claim it into your account \u201c{name}\u201d.',
    ...
    claimIntoExisting: 'Receive into one of your accounts:',
    claimOr: 'or',
    ...
    walletSettings: 'Account settings',
    walletSettingsDesc: 'Name, recovery phrase, public key, and auto-logout for this account.',
    autolockTitle: 'Log out automatically',
    autolockDesc: "After the app has been in the background this long, log this wallet out — it's removed from this device (including from Save to device), so keep its recovery phrase. Other accounts aren't affected. The timer never runs while the app is open and focused.",
    autolockNever: 'Never',
    ...
    arkBoardedNote: 'Ready to spend after {n} confirmations.',
    arkBoardedNoteOne: 'Ready to spend after 1 confirmation.',
    ...
    arkRenewForecast: 'Coins renew in ~{when} for {fee}.',
    arkRenewForecastNow: 'Coins renew shortly for {fee}.',
    ...
    arkExitNoFeeCoin: 'Paused: the next step needs about {need} sats in Savings for its mining fee. Top up Savings and it resumes by itself.',
    arkExitFeeShort: 'Savings can’t cover the exit’s mining fees (about {need} sats needed, {have} available). Top up Savings first.',
    ...
    arkExitingHistory: 'Moving to Savings',
    arkExitPendingTag: 'in progress',
    arkNoSpendableMidExit: 'No spendable balance — your coins are on their way to Savings in an on-chain exit.',
    arkExitInFlightLink: 'Exit in progress ({n} sats) — view details',
    ...
    arkServerTitle: 'Ark server',
    arkServerDesc: 'Spending runs on an Ark server. coinos runs one; Second runs another; or point at your own. Coins are held per server — switch back any time to reach what a server holds.',
    arkServerCustomUrl: 'Ark server URL (https://…)',
    arkServerCustomEsplora: 'Esplora API URL for that server',
    arkServerCustomNeeded: 'Enter both the Ark server and its Esplora URL first',
    arkServerSwitchWarn: '{amount} sats are held with the current server. They stay there — switch back to reach them — but they can’t be spent from the new one. To move them, send or exit them first.',
    arkServerSwitchGo: 'Switch server',
    arkCmpShow: 'Compare the servers',
    arkCmpHide: 'Hide the comparison',
    arkCmpRunBy: 'Run by',
    arkCmpRunByCoinos: 'coinos',
    arkCmpRunBySecond: 'Second, the makers of Ark',
    arkCmpRunByOther: 'someone else',
    arkCmpLifetime: 'Coin lifetime before renewal',
    arkCmpRounds: 'Rounds',
    arkCmpEvery: 'every {n} min',
    arkCmpRenew: 'Renewal fee',
    arkCmpLnSend: 'Lightning send fee',
    arkCmpLnRecv: 'Lightning receive fee',
    arkCmpExit: 'Cooperative exit fee',
    arkCmpBoard: 'Boarding',
    arkCmpBoardVal: 'min {min} sats, {n} confirmations',
    arkCmpMaxCoin: 'Largest coin',
    arkCmpFree: 'free',
    ...
    arkLnFromSavingsBody: 'Lightning payments leave your Spending balance, not Savings. Spending holds {have}.',
    arkLnFromSavingsShort: 'Spending can’t cover this one. Move funds over from Savings first — that takes an on-chain confirmation, so ask for a fresh invoice afterwards.',
    arkLnUseSpending: 'Switch to Spending and continue',
    arkLnMoveFirst: 'Move Savings into Spending first',
    arkLnFee: 'Fee',
    ...
    composePreviewEmpty: 'Nothing to preview yet.',
    ...
    onbBackupLater: 'Later',
    backupReminder: 'Your recovery phrase is still unwritten.',
    backupReminderGo: 'Write it down',
    ...
    namesPosHow: 'A coinos POS terminal takes payments to this address. Create a token and enter it as the API token when you flash the terminal at coinos.io/flash. The terminal can ring up sales and see them paid; it can never spend.',
    namesPosCreate: 'Create POS token',
    namesPosCopy: 'Copy token',
    namesPosRevoke: 'Revoke tokens',
    namesPosRevoked: 'POS tokens revoked',
    namesPosLink: 'Tap-to-pay link',
    namesPosLinkHow: 'What the terminal broadcasts over NFC. Any lightning wallet that scans it pays the sale the terminal just rang up, or asks for an amount. Print it as a sticker if you like.',
    namesPosCopyLnurl: 'Copy LNURL',
    namesPosCopyLink: 'Copy link',
    ...
    namesOwnNodeSet: 'Delivery updated — payments go to your node',
    namesOwnNodeCleared: 'Payments land in this wallet again',
    namesOwnNodeNoRelay: 'That offer code names no relay',
    namesOwnLnoHow: 'Or paste your node’s BOLT12 offer (lno1…) — it goes into your address’s DNS record, so senders fetch invoices straight from your node.',
    namesOwnLnoActive: 'Your address’s DNS record carries your own node’s offer:',
    namesOwnLnoBad: 'That doesn’t look like a BOLT12 offer',
    bolt12Currency: 'This offer is priced in {currency}, which this wallet can’t pay',
    clinkBadInvoice: 'The recipient’s service returned an invoice that doesn’t match',
    clinkFixedAmount: 'This offer has a fixed price',
    ...
    zapSetupDesc: 'One tap on ⚡ sends this amount instantly — no form, no confirmation. Change it any time by holding ⚡, or in Settings → Payments.',
    ...
    searchUsersHint: 'Name, npub, address, or #topic…',
