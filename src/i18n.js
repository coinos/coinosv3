...
const STR = {
  en: {
    ...
    arkDepthTitle: 'Advanced · exit cost',
    arkDepthBody: 'Your coins’ off-chain history is {d} hops deep. A trustless exit would currently cost about {fee} sats in mining fees — each hop is one more on-chain transaction. Renewing now flattens the history back to a single hop for {renew}.',
    arkDepthFree: 'free',
    arkDepthBtn: 'Renew now',
    arkDepthRenewed: 'Renewal requested — your coins flatten when the next round completes.',
