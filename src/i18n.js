...
const STR = {
  en: {
    ...
    arkDepthNotice: 'Self-custody exit currently costs about {fee} sats in mining fees. Renew for {renew} to bring that down to about {after} sats.',
    arkDepthFree: 'free',
    arkDepthBtn: 'Renew now',
    arkDepthRenewed: 'Renewal requested — it completes with the next round.',
