...
const STR = {
  en: {
    ...
    arkCoinsRenewDesc: 'Renewing asks the server to replace your coins with a single fresh one in its next round (which can be up to an hour out). That flattens the history, restarts the expiry clock, and costs {fee}.',
