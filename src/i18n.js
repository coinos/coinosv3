...
const STR = {
  en: {
    ...
    arkCoinsChipExp: 'expiry {d}',
    arkCoinsChipExit: 'exit cost {fee}',
    arkCoinsChipRenew: 'renewal cost {fee}',
    ...
    arkCoinsChipRenewTiny: 'under 1 sat',
    ...
    arkCoinsRenewDesc: 'Renewing asks the server to replace your coins with a single fresh one in its next round (which can be up to an hour out). That flattens the history and restarts the expiry clock. The fee depends on how much lifetime a coin still carries — waiting is cheaper:',
    arkCoinsRenewAuto: 'In the final stretch renewal is free, and the wallet does it there automatically. Renewing sooner only buys the cheaper self-custody exit sooner.',
