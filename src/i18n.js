...
const STR = {
  en: {
    ...
    arkReconSent: 'Sent',
    arkReconTag: 'synced',
    arkReconCoins: '{n} coins',
    arkReconExplain: 'This device has no record of this payment — the coins left your wallet in a session this device didn’t see. That usually means another device or browser you use, or history that didn’t survive a restore; it can also be a renewal the server handled for you. Your balance is correct — this entry keeps the history adding up to it.',
    ...
    arkCoinsChipDepth: 'depth {d}',
    arkCoinsChipExit: 'exit {fee}',
