...
const STR = {
  en: {
    ...
    onbHaveWallet: 'I already have a wallet',
    ...
    onbNameTitle: 'Claim your username',
    onbNameBody: 'Your payment address — people can send you bitcoin with just this.',
    onbNameWait: 'Getting things ready…',
    onbSkipName: 'Skip for now',
