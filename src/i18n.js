...
const STR = {
  en: {
    ...
    entropyHint: 'The seed comes from exactly what you type (SHA-256 → BIP-39). Entering the same text again recreates the same wallet, on any device.',
    entropyWarn: '⚠ Nothing else is added: anyone who can guess this text can take your money. Use plenty of real-world randomness — think 50+ dice rolls.',
    ...
    hatShopBlurb: 'Support coinos and wear the proof: your hat shows above your avatar everywhere you appear.',
    ...
    hatMainnetOnly: 'Hats are sold on mainnet only',
